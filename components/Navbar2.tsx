...
const Navbar2 = () => {
  return (
    <nav className="flex flex-wrap items-center px-4 bg-gray-900">
      <a
        href="#"
      ...
      >
        <div className="flex flex-col mr-auto lg:flex-row">
          <a href="#" className="hover:text-gray-400 lg:p-4 py-2 text-white">
            Home
          </a>
          <a href="#" className="hover:text-gray-400 lg:p-4 py-2 text-white">
            Offers
        ...
        <div className="flex-wrap inline-flex items-center py-1 space-x-2">
          <a
            href="#"
            className="border border-primary-500 hover:bg-primary-500 hover:text-white inline-block px-6 py-2 text-primary-500"
          >
            Log In
          </a>
          <a
            href="#"
            className="bg-primary-500 border border-primary-500 hover:bg-primary-600 inline-block px-6 py-2 text-white"
          >
            Sign Up
          </a>
        </div>
